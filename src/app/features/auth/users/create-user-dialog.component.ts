...
import { CreateUserDto, UserTypeDto, RoleDto } from '../../../core/models';
  ...
  template: `
    ...
    <div mat-dialog-content class="dialog-content">
      <form #userForm="ngForm">
        ...
        <!-- Campos adicionales -->
        <mat-expansion-panel class="additional-fields">
          <mat-expansion-panel-header>
            <mat-panel-title>
...
export class CreateUserDialogComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: { userTypes: UserTypeDto[] },
    private authService: AuthService
  ) {}

  ngOnInit(): void {
    // Inicializar con un campo adicional vacío
    this.addField();
